...
,
  // ── 21. service — Setup Service Gitar Akustik ────────────────────────────────
  {
    id: "art-service-akustik-001",
    slug: "service-setup-dasar-akustik",
    title: "Layanan Service Setup Dasar Gitar Akustik",
    description: "Layanan setup dasar untuk gitar akustik — pemeriksaan bridge, nut, neck relief, action, intonasi, dan kondisi fret.",
    category: "akustik",
    domains: ["setup", "maintenance", "professional-services"],
    contentType: "service",
    difficulty: "pemula",
    ...
    sources: [
      {
        ...
        publisher: "Fender",
        accessDate: "2026-08-28",
        note: "Manufacturer official documentation for acoustic guitar setup principles.",
      },
      {
        title: "Gibson Acoustic Guitar Service Reference (structural reference)",
        tier: "primary" as const,
        author: "Gibson",
        publisher: "Gibson Guitar Corporation",
        accessDate: "2026-08-28",
        note: "Comparative reference for acoustic guitar service requirements.",
      },
    ],
    updatedAt: "2026-08-28",
    body: {
      contentType: "service",
      apaItu: "Service setup dasar gitar akustik adalah layanan pemeriksaan dan penyesuaian komponen utama gitar akustik untuk memastikan instrumen bermain optimal. Akustik memerlukan perhatian khusus terhadap kondisi bridge, nut, fret, neck relief, dan resonansi body — aspek yang berbeda dari gitar elektrik yang memiliki elektronik dan tremolo.",
      mencakup: [
        "Pemeriksaan kondisi bridge dan pin — retak, keausan, atau lepas",
        "Pemeriksaan kondisi nut — kedalaman slot dan kelancaran senar",
        "Pemeriksaan dan penyesuaian neck relief (truss rod — hanya jika tersedia pada model)",
        "Pemeriksaan dan penyesuaian action (ketinggian senar) di bridge",
        "Pemeriksaan intonasi (jarak nut ke saddle — pengukuran relatif)",
        "Pemeriksaan kondisi fret — keausan, kerusakan, atau tidak rata",
        "Pemeriksaan kondisi body — retak, kerusakan kayu, atau perubahan resonansi",
        "Pemeriksaan kondisi hardware — tuner, strap pin",
        "Pembersihan umum — fret, body, bridge",
      ],
      durasi: "Setup dasar gitar akustik umumnya 30-60 menit. Gitar dengan kondisi buruk atau bridge yang memerlukan perhatian khusus bisa memakan waktu lebih lama. Gitar vintage atau dengan bridge yang sudah tidak stabil memerlukan penanganan lebih hati-hati.",
      tools: ["Truss rod wrench (jika tersedia pada gitar)", "Feeler gauge", "Ruler", "Capo", "Screwdriver / hex key set", "Cleaning supplies", "Feeler gauge untuk bridge/saddle", "Tuner elektronik"],
      proses: "Proses setup dasar akustik: (1) Inspeksi awal — periksa kondisi umum body, neck, bridge, fret, dan nut. (2) Pemeriksaan neck relief — ukur dengan capo dan feeler gauge di fret tengah. (3) Pemeriksaan action — ukur ketinggian senar di fret 12. (4) Pemeriksaan kondisi nut dan bridge. (5) Pemeriksaan kondisi fret. (6) Pemeriksaan resonansi body. (7) Pemeriksaan hardware. (8) Pembersihan. (9) Test play — periksa fret buzz, tuning stability, dan kualitas suara.",
      risiko: "Risiko setup akustik: (1) Truss rod (jika ada) yang diputar berlebihan merusak leher. (2) Bridge yang disetel salah dapat merubah intonasi atau membuat gitar tidak stabil. (3) Nut yang difile terlalu dalam merusak nut. (4) Pembersihan yang terlalu keras merusak lapisan body. (5) Penyesuaian bridge pada gitar vintage memerlukan perhatian khusus karena komponen mungkin sudah rapuh. Teknisi berpengalaman selalu memeriksa kondisi sebelum penyesuaian besar.",
      lihatProfesional: "Bawa ke teknisi profesional atau luthier untuk setup akustik — layanan ini ditawarkan oleh toko musik dan teknisi servis. Akustik dengan bridge yang sudah rapuh, retak body, atau kondisi vintage memerlukan teknisi berpengalaman. Hindari setup sendiri jika: (1) gitar adalah instrumen koleksi atau vintage bernilai tinggi, (2) bridge memerlukan perbaikan atau penggantian, (3) tidak memiliki alat yang sesuai, (4) tidak yakin dengan prosedur truss rod atau intonasi.",
      topikTerkait: [
        "apa-itu-setup-gitar-akustik",
        "pengukuran-neck-relief",
        "pengukuran-action-string-height",
...
,
  ...
  // ── 22. measurement — Pengukuran Action String Elektrik ─────────────────────
  {
    id: "art-meas-action-elektrik-001",
    slug: "pengukuran-action-string-elektrik",
    title: "Pengukuran Action / String Height pada Gitar Elektrik",
    description: "Panduan pengukuran action (string height) pada gitar elektrik — di fret 12 dan fret pertama, perbedaan dari akustik dan bass.",
    category: "elektrik",
    domains: ["measurement", "setup", "maintenance"],
    contentType: "measurement",
    difficulty: "pemula",
    ...
    sources: [
      {
        ...
        publisher: "Fender",
        accessDate: "2026-08-28",
        note: "Manufacturer official documentation. Action height varies per electric guitar model, scale length, and string gauge.",
      },
      {
        title: "Gibson Electric Guitar Setup Reference (structural reference)",
        tier: "primary" as const,
        author: "Gibson Guitar Corporation",
        publisher: "Gibson",
        accessDate: "2026-08-28",
        note: "Comparative reference for electric guitar action measurement approach.",
      },
    ],
    updatedAt: "2026-08-28",
    body: {
      contentType: "measurement",
      apaItu: "Action (string height) pada gitar elektrik adalah jarak antara senar dan fret di titik pengukuran. Elektrik menggunakan skala lebih pendek (25.5 inci untuk Strat/Tele vs 24.75 untuk Les Paul) dan string gauge lebih ringan dari akustik. Action elektrik bisa lebih rendah dari akustik karena string lebih lentur dan pemain elektrik umumnya menggunakan fingerstyle atau pick dengan tekanan lebih rendah.",
      target: "Tujuan pengukuran action elektrik: memastikan senar tidak terlalu rendah (menyebabkan fret buzz) atau terlalu tinggi (memperpendek sustain dan sulit ditekan). Action elektrik khas lebih rendah dari akustik.",
